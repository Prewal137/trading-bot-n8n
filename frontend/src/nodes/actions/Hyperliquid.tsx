...
export function Hyperliquid({ data, isConnectable }: {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-xl border border-white/20 shadow-xl rounded-2xl min-w-[200px] text-sm transition-all hover:shadow-2xl">
      <div className="px-4 py-3 bg-gradient-to-r from-orange-500/10 to-rose-500/10 border-b border-rose-100/50 rounded-t-2xl">
      ...
      <Handle 
        ...
        className="w-3 h-3 rounded-full bg-rose-500 border-2 border-white shadow-sm"
      />
      <Handle 
        type="source" 
